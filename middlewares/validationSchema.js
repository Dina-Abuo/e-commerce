...
export const validationUserSchema = () => [
  ...
  body("address.city")
    ...
    .isLength({ min: 2 }).withMessage("City must be at least 2 chars"),

  body("address.street")
    .notEmpty().withMessage("Street is required")
    .isLength({ min: 2 }).withMessage("Street must be at least 2 chars"),
];

export const validationProductSchema = () => [
  body("title")
  ...
  body("productName")
    ...
    .isLength({ min: 2 }).withMessage("Product Name at least is 2 digits"),
];
